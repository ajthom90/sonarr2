...
// indexerResource is the Sonarr v3 JSON shape for an indexer instance.
...
// indexerHandler handles /api/v3/indexer endpoints.
...
// NewIndexerHandler constructs an indexerHandler.
...
// MountIndexer registers /api/v3/indexer routes.
func MountIndexer(r chi.Router, h *indexerHandler) {
	r.Route("/api/v3/indexer", func(r chi.Router) {
...
// schema handles GET /api/v3/indexer/schema.
...
// create handles POST /api/v3/indexer.
func (h *indexerHandler) create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.log.Error("indexer create", slog.String("err", err.Error()))
		writeError(w, http.StatusInternalServerError, "Internal Server Error")
		return
	}
...
// get handles GET /api/v3/indexer/{id}.
func (h *indexerHandler) get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.log.Error("indexer get", slog.String("err", err.Error()))
		writeError(w, http.StatusInternalServerError, "Internal Server Error")
		return
	}
...
// update handles PUT /api/v3/indexer/{id}.
func (h *indexerHandler) update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.log.Error("indexer update get", slog.String("err", err.Error()))
		writeError(w, http.StatusInternalServerError, "Internal Server Error")
		return
	}
	...
	if err := h.store.Update(r.Context(), existing); err != nil {
		h.log.Error("indexer update", slog.String("err", err.Error()))
		writeError(w, http.StatusInternalServerError, "Internal Server Error")
		return
	}
...
// delete handles DELETE /api/v3/indexer/{id}.
func (h *indexerHandler) delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.store.Delete(r.Context(), id); err != nil {
		...
		h.log.Error("indexer delete", slog.String("err", err.Error()))
		writeError(w, http.StatusInternalServerError, "Internal Server Error")
		return
	}
